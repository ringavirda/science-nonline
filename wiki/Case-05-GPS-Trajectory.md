...
![Maneuvering trajectory: truth vs raw fixes vs dtfit (EAC, fused) vs Kalman; red x mark fused-detector maneuver flags.](figures/trajectory.png)

*Maneuvering trajectory: truth vs raw fixes vs dtfit (EAC, fused) vs Kalman; red x mark fused-detector maneuver flags.*
