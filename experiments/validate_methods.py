...
Run experiments/download_data.py first, then:
    ...
    python experiments/validate_methods.py
...
What it does:
  ...
  * USD/UAH (2014-2015 hryvnia crisis)
      ...
      -> EqualAreasFilter streaming: one-step-ahead online forecasting
...
def experiment_currency_streaming() -> None:
    rule("USD/UAH 2014-2015 -- EqualAreasFilter online tracking (bounded cost)")
    dates, rate = load_csv("usd_uah_2014_2015.csv")
    n = rate.size
    window = 30
