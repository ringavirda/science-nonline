...
> [`extra/dt/lsi.py`](../../src/dtfit/extra/dt/lsi.py).
> Invoke via `dt.fit_lsi(x, y, expr, var, ...)`,
> `nonline_fit(..., method="lsi", data_x=, data_y=)`,
> `FittingNonlineMw(method="lsi")`, or `NonlineRegressor(..., method="lsi")`.
...
[EqualAreasFilter](equal_areas_filter.md); for the most noise-robust batch fit
