...
Source: [`experiments/common/baselines.py`](../../packages/dtfit-experimental/src/dtfit_experimental/experiments/common/baselines.py).
...
[README.md](README.md) for the suite overview.
