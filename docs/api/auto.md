...
| `"oscillatory"` | [`fit_lsi`](fitting.md#fit_lsi) with the oscillatory recipe |
| `"transient"` / `"peak"` | [`fit_eda_adaptive`](fitting.md#fit_eda_adaptive) (curvature windows) |
| `"robust"` | [`fit_eda`](fitting.md#fit_eda) with `loss="soft_l1"` |
