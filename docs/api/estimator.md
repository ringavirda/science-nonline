...
### `score(X, y) -> float`
Inherited from `RegressorMixin` — the R² of the prediction.
...
- For uncertainty (`stderr`, confidence intervals, prediction bands), call the
  underlying [`fit_lsi`](fitting.md#fit_lsi) / [`fit_eda`](fitting.md#fit_eda)
  directly and use the returned [`FittingResult`](types.md); the sklearn estimator
