...
They all rest on the one idea from [the guide](README.md): *match the integral
...
Full math: [../methods/dsb.md](../methods/dsb.md).
...
Full math: [../methods/lsi.md](../methods/lsi.md).
...
isn't, is in [../methods/lsi.md](../methods/lsi.md).
...
- **The oscillatory recipe** (`oscillatory=True` / `freq_param=`): smoothing and
  ...
  [fft_frequency_seed](../api/fitting.md#fft_frequency_seed).
...
Full math: [../methods/eda.md](../methods/eda.md).
...
identification — the formal statement is in [../methods/eda.md](../methods/eda.md)).
...
Full math: [../methods/equal_areas_filter.md](../methods/equal_areas_filter.md).
...
3. Apply the Kalman correction: move the parameters by gain × surprise, and
...
are detailed in [../methods/equal_areas_filter.md](../methods/equal_areas_filter.md).
...
- **`FilterBank` + `FusedChiSquareDetector`** — run many streams in lockstep and
  ...
  strong across all of them. → [api/streaming.md](../api/streaming.md)
...
- **Which one for my data?** → [choosing-a-method.md](choosing-a-method.md)
