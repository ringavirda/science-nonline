...
The differential-transformation batch fitters (``fit_lsi``, ``fit_eac``,
``fit_dsb`` and the adaptive-window EAC variant), the ``find_degree`` polynomial
...
from ._eac import fit_eac, fit_eac_adaptive
