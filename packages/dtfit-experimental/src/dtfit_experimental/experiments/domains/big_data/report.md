...
|---|---|---|---|---|
| dtfit EACFilter | 139.0 | bounded (7.8 MB) | 0.311 | **yes** (ω err 9.2%) |
...
![dtfit's streaming filter tracks the physical frequency online through a mid-stream jump at O(1)/sample.](figures/online_tracking.png)
