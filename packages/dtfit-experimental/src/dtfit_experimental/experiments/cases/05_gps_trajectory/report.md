...
![Maneuvering trajectory: truth vs raw fixes vs dtfit (EDA, fused) vs Kalman; red × mark fused-detector maneuver flags.](figures/trajectory.png)

*Maneuvering trajectory: truth vs raw fixes vs dtfit (EDA, fused) vs Kalman; red × mark fused-detector maneuver flags.*
