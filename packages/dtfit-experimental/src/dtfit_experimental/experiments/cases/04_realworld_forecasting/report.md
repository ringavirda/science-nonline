...
- **Mauna Loa CO₂:** **stage-wise boosting (#5)** = quadratic trend `a0 + a1·x + a2·x²` (LSI) + seasonal `A·sin(w·x + p)` (LSI) — CO₂ is a smooth rising trend plus an annual cycle, which the additive composite captures.
