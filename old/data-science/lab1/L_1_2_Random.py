...
def rando_norm(dm, dsig, iter):
    S = np.random.normal(
        dm, dsig, iter
    )  # нормальний закон розподілу ВВ з вибіркою об'ємом iter та параметрами: dm, dsig
    mS = np.mean(S)
    dS = np.var(S)
    scvS = mt.sqrt(dS)
    ...
    print("------------------------------------------------------------------------")
    # гістограма закону розподілу ВВ
    plt.hist(S, bins=8, facecolor="blue", alpha=0.5)
    plt.show()
    return S
...
def rando_exponential(alfa, iter):
    S = np.random.exponential(
        alfa, iter
    )  # експоненційний закон розподілу ВВ з вибіркою об'ємом iter та параметрами: dsig
    mS = np.mean(S)
    dS = np.var(S)
    scvS = mt.sqrt(dS)
    print(
        "------- статистичне характеристики ЕКСПОНЕНЦІЙНОГО закону розподілу ВВ -----"
    )
    print("математичне сподівання ВВ=", mS)
    print("дисперсія ВВ =", dS)
    print("СКВ ВВ=", scvS)
...
# ------------------------- хі квадрат закон розподілу ВВ ----------------------------
def rando_chisquare(k, iter):
    S = np.random.chisquare(
        k, iter
    )  # хі квадрат закон розподілу ВВ з вибіркою об'ємом iter та параметрами: dsig
    mS = np.mean(S)
    dS = np.var(S)
    scvS = mt.sqrt(dS)
    print(
        "-------- статистичні характеристики ХІ КВАДРАТ закону розподілу ВВ ---------"
    )
    print("математичне сподівання ВВ=", mS)
    print("дисперсія ВВ =", dS)
    print("СКВ ВВ=", scvS)
...
if __name__ == "__main__":
    ...
    if mode == 1:
        print(
            " ---------------- Обрано: рівномірний закон розподілу ВВ -----------------"
        )
        print(
            "------------------ ВХІДНІ параметри законі розподілу ВВ:------------------"
        )
        a = 0
        b = 10
        iter = 10000
    ...
    if mode == 2:
        print(
            "------------------ Обрано: нормальний закон розподілу ВВ -----------------"
        )
        print(
            "------------------- ВХІДНІ параметри законі розподілу ВВ:-----------------"
        )
    ...
    if mode == 3:
        print(
            "----------------- Обрано: експоненційний закон розподілу ВВ --------------"
        )
        print(
            "------------------- ВХІДНІ параметри законі розподілу ВВ:-----------------"
        )
    ...
    if mode == 4:
        print(
            "-------------------- Обрано: хі квадрат закон розподілу ВВ ---------------"
        )
        print(
            "--------------------- ВХІДНІ параметри законі розподілу ВВ: --------------"
        )
